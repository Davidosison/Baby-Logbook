...
export default function SleepPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-background pb-32 flex flex-col">
      <PageHeader title="Sleep" hebrewTitle="שינה" />
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 pb-20">
        ...
        {isSleeping ? (
          <div className="text-center mb-12">
            ...
            <div className="text-lg text-muted-foreground font-medium">Asleep</div>
          </div>
        ) : (
          <div className="text-center mb-12">
            <div className="text-2xl text-muted-foreground font-medium">Baby is awake</div>
          </div>
        )}
